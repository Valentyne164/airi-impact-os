                ...
                <div className="px-5 pb-5 bg-[#f7faf6] border-t border-line">
                  <form action={updateAction} className="mt-4 grid sm:grid-cols-2 gap-3">
                    ...
                    <div className="sm:col-span-2 flex items-center gap-2 pt-1">
                      ...
                      <DeleteButton
                        action={deleteAction}
                        confirmMessage={`Delete metric "${m.label}"? This cannot be undone.`}
            ...
            <form action={addMetricAction} className="grid sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select name="kind"
                  ...
                  <option value="percent">Percentage (0–100, averaged)</option>
          ...
          <div className="divide-y divide-red-100">
            ...
            <div className="px-6 py-4 flex items-start justify-between gap-6">
              ...
              <DeleteButton
                ...
                confirmMessage={`Archive "${program.name}"? It will be hidden from all views but data is kept.`}
